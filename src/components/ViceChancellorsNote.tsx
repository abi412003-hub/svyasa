      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-foreground mt-3">Vice Chancellor's Note</h2>
            <motion.div
          ...
          <div className="grid md:grid-cols-5 gap-10 items-center">
            ...
            >
              <div className="relative">
                ...
                {/* Name plate */}
                <motion.div
                  className="absolute -bottom-5 left-1/2 -translate-x-1/2 z-20 bg-secondary text-white px-5 py-2.5 rounded-full shadow-lg text-center whitespace-nowrap"
