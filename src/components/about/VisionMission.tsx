...
const VisionMission = () => {
  ...
  return <section ref={ref} className="py-20 bg-background relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 relative">
          ...
          scale: 1.02
            ...
            {/* Background Mandala */}
            <motion.div className="absolute -right-20 -bottom-20 w-64 h-64 opacity-10" animate={{
            rotate: 360
          }} transition={{
            duration: 60,
            repeat: Infinity,
            ease: "linear"
              ...
              <svg viewBox="0 0 100 100" className="w-full h-full text-primary">
                ...
                {[...Array(12)].map((_, i) => <line key={i} x1="50" y1="5" x2="50" y2="50" stroke="currentColor" strokeWidth="0.5" transform={`rotate(${i * 30} 50 50)`} />)}
              </svg>
            </motion.div>
          ...
          scale: 1.02
            ...
            <motion.div className="absolute -left-20 -bottom-20 w-64 h-64 opacity-10" animate={{
            rotate: -360
          }} transition={{
            duration: 60,
            repeat: Infinity,
