...
import devarajaImg from "@/assets/research/devaraja.jpg";
...
export const facultyData: FacultyProfile[] = [
  ...
  },
  {
    ...
    section: "leadership",
    achievements: [
      "Awarded an honorary Doctor of Science (D.Sc.) degree by S-VYASA University in recognition of his significant contributions to Yoga research",
      "Delivered lectures on evidence-based Yoga therapy and conducted workshops at Harvard Medical School (USA), Monash University (Australia), Royal College of Medicine (London), Shanghai University of Sports (China), and Pharma University (Italy)",
      "Member of Scientific Advisory Committee, Department of Science and Technology; Research Advisory Committee for Integrative Medicine Initiative of NITI Aayog; Core Committee for Yoga Accreditation in Higher Education under NAAC, Government of India",
      "Member of Steering Committee for Yoga Programs and Accreditation at Yunnan Minzu University, China; Expert Committee Member for development of Yoga training benchmarks at WHO, Switzerland",
      "Vice President of Vivekananda Yoga University, California, USA, and the Asian Yoga Therapy Association, Singapore",
      "Founding Director of Vivekananda Health Global — a global chain of integrative medicine clinics and hospitals",
      "Recipient of Bharat Gaurav Award at the House of Commons, British Parliament, London; IASTAM Yoga Forum Munich Patanjali Award; Indigenous Knowledge and Peace Education Award by The World Peace Congress at India International Centre, New Delhi",
    ],
    research:
